    ...
    <div className="nav_container">
      ...
      <div className="contact__container container">
        <div className="contact__data">
          <h3 className={MyElem ? "contact__title contact__title-anim":"contact__title"} ref={myLinkAnim}>Uyatchanglik qilmang!</h3>
          <div className={MyElem ? "contact__info contact__info-anim":"contact__info"} ref={myLinkAnim}>
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">mador19931219@gmail.com</h4>
              </div>
            </div>
            <div className="info__item">
              <FaPhoneSquareAlt className='info__icon'/>
              <div>
                <span className="info__title">Telefon raqamim</span>
                <h4 className="info__desc">+998 90 149 20 40</h4>
              </div>
            </div>
          </div>
          <div className={MyElem ? "contact__socials contact__socials-anim":"contact__socials"} ref={myLinkAnim}>
            <a href="https://www.facebook.com/mador.turgunboyev" className='contact__social-link'>
              <FaFacebookF/>
            </a>
            <a href="https://t.me/+NKO7oQ7pLUI0ZTcy" className='contact__social-link'>
              <FaTelegram/>
            </a>
            <a href="https://youtube.com/@madorturgunboyev7390
" className='contact__social-link'>
              <FaYoutube/>
            </a>
            <a href="https://github.com/Madorshoh" className='contact__social-link'>
              <FaGithub/>
            </a>
          </div>
        </div>
